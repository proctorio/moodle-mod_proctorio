...
/**
 * AJAX endpoint returning candidate CSS selector configuration as JSON.
 *
...
if ($_SERVER['HTTP_X_REQUESTED_WITH'] === 'XMLHttpRequest' && isloggedin()) {
    try {
        ...
        echo json_encode(['error' => local_proctorio_log_and_get_client_message($e, 'ajax')]);
    }
    exit;
} else {
